...
class _CabRideScreenState extends State<CabRideScreen> {
              ...
              children: [
                      ...
                      markers: [
                            ...
                            ..._economyLocations.asMap().entries.map((entry) {
                              ...
                              return Marker(
                                ...
                                child: Transform.rotate(
                                  angle: rotationAngle,
                                  child: Image.asset('assets/images/topview/economy-top.png', width: 50, height: 50, fit: BoxFit.contain, errorBuilder: (context, error, stackTrace) => Icon(Icons.directions_car, color: Color(0xFF2196F3), size: 24)),
                                ),
                              );
                            }).toList(),
                          if (_selectedVehicle == 'SUV')
                            ..._suvLocations.asMap().entries.map((entry) {
                              ...
                              return Marker(
                                ...
                                child: Transform.rotate(
                                  angle: rotationAngle,
                                  child: Image.asset('assets/images/topview/suv-top.png', width: 50, height: 50, fit: BoxFit.contain, errorBuilder: (context, error, stackTrace) => Icon(Icons.airport_shuttle, color: Color(0xFF2196F3), size: 24)),
                                ),
                              );
                            }).toList(),
                          if (_selectedVehicle == 'Premium')
                            ..._premiumLocations.asMap().entries.map((entry) {
                              ...
                              return Marker(
                                ...
                                child: Transform.rotate(
                                  angle: rotationAngle,
                                  child: Image.asset('assets/images/topview/primium-top.png', width: 50, height: 50, fit: BoxFit.contain, errorBuilder: (context, error, stackTrace) => Icon(Icons.directions_car, color: Color(0xFF2196F3), size: 24)),
                                ),
                              );
                            }).toList(),
                        ],
                        if (_isTaxiComing && _comingTaxiLocation != null && !_showFullTripMap)
                          Marker(
                            ...
                            height: 60,
                            child: Image.asset(
                              _selectedVehicle == 'SUV' ? 'assets/images/topview/suv-top.png' : _selectedVehicle == 'Premium' ? 'assets/images/topview/primium-top.png' : 'assets/images/topview/economy-top.png',
                              width: 60,
                              height: 60,
                              fit: BoxFit.contain,
                ...
                if (!_showFullTripMap)
                  DraggableScrollableSheet(
                    ...
                    minChildSize: _showPickupConfirmation ? 0.18 : 0.45,
                    maxChildSize: _showPickupConfirmation ? 0.18 : 0.45,
                              ...
                              child: ListView(
                                ...
                                children: [
                                  if (_showPickupConfirmation) ...[
                                    ...
                                    const Text('Cab Ride', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                                  ],
              ...
              child: SafeArea(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      _selectedVehicle == null ? 'Select a vehicle' : _showPickupConfirmation ? 'Confirm Pickup' : 'Book Cab Ride',
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text('Support your driver by adding a tip', style: TextStyle(fontSize: 14, color: Colors.grey), textAlign: TextAlign.center),
                  const SizedBox(height: 16),
                  Container(
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(color: Colors.grey[50], borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.grey[200]!)),
                    child: Row(
                      ...
                      children: [
                        Text('Total Fare: ${selectedVehicleData['price']}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        ...
        return Container(
          ...
          child: const Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text('Finding your Cab', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              SizedBox(height: 8),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Your cab on the way', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
              const SizedBox(height: 12),
              Row(
              ...
              const Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('Arriving in 4 mins', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                  SizedBox(width: 12),
                  Icon(Icons.location_on, color: Colors.green, size: 18),
                  SizedBox(width: 8),
                  Text('1.2 km away', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                ],
              ),
              const SizedBox(height: 16),
              Container(
                ...
                child: Row(
                  children: [
                    Container(width: 55, height: 55, decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: Colors.grey[200]!, width: 2), image: const DecorationImage(image: NetworkImage('https://i.pravatar.cc/150?u=rajesh'), fit: BoxFit.cover))),
                    const SizedBox(width: 12),
                    const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Rajesh Kumar', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)), SizedBox(height: 4), Row(children: [Icon(Icons.star, color: Colors.amber, size: 16), SizedBox(width: 4), Text('4.9 (1.2k+ rides)', style: TextStyle(fontSize: 13, color: Colors.grey))]), SizedBox(height: 4), Text('White Swift Dzire • DL 01 AB 1234', style: TextStyle(fontSize: 11, color: Colors.grey))])),
                    SizedBox(width: 90, height: 70, child: Image.asset(selectedVehicleData['image'], fit: BoxFit.contain)),
                  ],
                ),
              ),
              const SizedBox(height: 16),
  ...
  void _showCancelReasonDialog() {
    final List<String> reasons = ['Plan changed', 'Driver is too far', 'Found another ride', 'Wait time is too long', 'Wrong location selected', 'Other'];
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              SizedBox(width: double.infinity, child: ElevatedButton(onPressed: () { Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (context) => RatingScreen(driverName: 'Rajesh Kumar', vehicleName: _selectedVehicle!, selectedTip: _selectedTip))); }, style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF2196F3), padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))), child: const Text('Rate Your Ride', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)))),
            ],
          ),
        );
      },
