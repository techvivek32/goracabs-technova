                              ...
                              child: ListView(
                                ...
                                children: [
                                  if (_showPickupConfirmation) ...[
                                    ...
                                    const Text('Auto Ride', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                                  ],
              ...
              child: SafeArea(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      _showPickupConfirmation ? 'Confirm Pickup' : 'Book Auto Ride',
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text('Total Fare: ₹76', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        ...
        return Container(
          ...
          child: const Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text('Finding your Auto', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              SizedBox(height: 8),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Your auto pilot on the way', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
              const SizedBox(height: 12),
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Text('3921', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: 2, color: Colors.black)),
                  ),
                ],
              ),
              const SizedBox(height: 16),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              SizedBox(width: double.infinity, child: ElevatedButton(onPressed: () { Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (context) => RatingScreen(driverName: 'Mahendra Kumar', vehicleName: 'Auto', selectedTip: _selectedTip))); }, style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF2196F3), padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))), child: const Text('Rate Your Ride', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)))),
            ],
          ),
        );
      },
